...
<div class="shop-bg-header">
    ...
    <!-- end header -->
    <div class="page-title ba-h2">OUR SHOP</div>
</div>
...
<script>
    jQuery(document).ready(function($) {
        ...
        addCards.forEach(function (addCard) {
            addCard.addEventListener('click', function (item) {
                item.target.parentNode.parentNode.parentNode.nextElementSibling.classList.add("show-panel");
                let productId = item.target.parentNode.previousElementSibling.value;
                let qtyH = item.target.parentNode.previousElementSibling.previousElementSibling.value;
                $.ajax({
                    //
                })
            })
