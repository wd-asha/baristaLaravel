...
<div class="shop-bg-header">
    ...
    <!-- end header -->
    <div class="page-title ba-h2">CHECKOUT</div>
</div>
...
<script>
    jQuery(document).ready(function ($) {
        let checkoutSliders = $('.checkout-slider');
        let checkoutCaptions = $('.checkout-caption');

        $( checkoutSliders ).each(function() {
            $(this).slideUp(100);
        });

        $( checkoutCaptions ).on( "click", function() {
            $(this).next('.checkout-slider').slideToggle(600);
        });
